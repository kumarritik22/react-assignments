...
const Card = ({item}) => {
  ...
  return (
    <div className='w-70 h-90 mt-8 bg-[#111111] rounded-lg border border-zinc-700'>
      ...
      <div className='p-4'>
        ...
        <p className='text-[#95a3b8] text-sm font-medium mb-6'>Experince Night City as a mercenary outlaw in this open-world, and you...</p> 
        <button onClick={() => {
